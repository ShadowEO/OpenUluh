 ...
 * @var JQMPHP_JQ
 */
define('JQMPHP_JQ', './jquery.mobile-1.0.1/jquery.js', true);

/**
 * Sets the jQuery Mobile path.
 * @var JQMPHP_JQM
 */
define('JQMPHP_JQM', './jquery.mobile-1.0.1/jquery.mobile-1.0.1.min.js', true);

/**
 * Sets the jQuery Mobile CSS path.
 * @var JQMPHP_CSS
 */
define('JQMPHP_CSS', './jquery.mobile-1.0.1.min.css', true);
